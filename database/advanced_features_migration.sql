-- Aurora RobbieVerse Migration: Advanced Features
...
CREATE TRIGGER update_personality_learning_profiles_updated_at 
    BEFORE UPDATE ON personality_learning_profiles 
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
